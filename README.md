...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spatialgeometry-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12636&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spatialgeometry-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spatialgeometry` can be installed with:

```
conda install spatialgeometry
```

It is possible to list all of the versions of `spatialgeometry` available on your platform with:
